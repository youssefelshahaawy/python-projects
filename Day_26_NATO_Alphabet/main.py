...
nato_phonetic_alphabet_dic = {row.letter:row.code for(index,row) in nato_phonetic_alphabet.iterrows()}
...
def generate_phonetic():
    ...
    try:
        list = [nato_phonetic_alphabet_dic[letter] for letter in user_word ]
    except KeyError :
